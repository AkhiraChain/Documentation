---
description: >-
  Reference this document for getting akhiranode setup and starting the process to
  becoming a validator in the akhirachain Network
---

# Running akhiranode & Becoming a Validator
...
Please refer to this [link](https://github.com/akhirachain/akhiranode/blob/develop/docs/chainOps/k8s.md) for the most up to date and accurate directions on how to finish this setup. 
